use crate::game::{
    ...
    grid::{self, Grid, GRID_WIDTH, GRID_HEIGHT},
...
impl GameState {
    ...
    pub fn tick(&mut self, inputs: &[Input]) {
        ...
        if consumed_apples > 0 {
            ...
            self.apples.retain(|apple| self.grid.get_cell(&apple.position) != Cell::Snake);
    ...
    fn spawn_apple(&mut self) {
        ...
        let mut rng = rand::rng();
        for _attempts in 0..100 { // Limit attempts to avoid infinite loop
